// Project-local MCP Blueprint graph bridge.
...
#define LOCTEXT_NAMESPACE "UMcpBlueprintGraphEditorBridge"
...
namespace
{
	...
	FMcpBlueprintGraphPin FindThenPin(const UK2Node* Node)
	{
		if (!::IsValid(Node))
		{
		...
		for (UEdGraphPin* Pin : Node->Pins)
		{
			...
			{
				return UMcpBlueprintGraphPinLibrary::FromNativePin(Pin);
			}
		}
	...
	bool HasUserDefinedPin(const UK2Node_EditablePinBase* Node, FName PinName)
	{
		if (!Node)
		{
			return false;
...
UMcpBlueprintGraphEditorBridge::UMcpBlueprintGraphEditorBridge()
{
}

UMcpBlueprintGraphEditorBridge* UMcpBlueprintGraphEditorBridge::CreateAndEditFunctionGraph(UBlueprint* InBlueprint, const FString& FuncName)
{
	if(!InBlueprint)
	{
		return nullptr;
	...
	UMcpBlueprintGraphEditorBridge* GraphEditor = NewObject<UMcpBlueprintGraphEditorBridge>();
...
UMcpBlueprintGraphEditorBridge* UMcpBlueprintGraphEditorBridge::GetGraphEditorByName(UBlueprint* InBlueprint, FName GraphName)
{
...
UMcpBlueprintGraphEditorBridge* UMcpBlueprintGraphEditorBridge::GetGraphEditor(UEdGraph* InGraph)
{
	if(!InGraph)
	{
...
void UMcpBlueprintGraphEditorBridge::ListAllNodes(TArray<UK2Node*>& OutNodes)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::ListNodesOfClass(TArray<UK2Node*>& OutNodes, TSubclassOf<UK2Node> Class)
{
	if(!IsValid() || !Class)
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::ListNodesWithErrors(TArray<UK2Node*>& OutNodes)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::ListNodesWithWarnings(TArray<UK2Node*>& OutNodes)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::ListNodesWithNotes(TArray<UK2Node*>& OutNodes)
{
	if(!IsValid())
	{
		return;
...
bool UMcpBlueprintGraphEditorBridge::RemoveGraphInputParameter(FName InputName)
{
	if(!IsValid())
	{
		return false;
...
FMcpBlueprintGraphPin UMcpBlueprintGraphEditorBridge::FindGraphEntryPin() const
{
	UK2Node_FunctionEntry* Entry = GetFunctionEntryNode();
	if(!Entry)
	{
	...
	return FindThenPin(Entry);
}

UK2Node_Event* UMcpBlueprintGraphEditorBridge::FindEventNode(FName EventName) const
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_FunctionResult* UMcpBlueprintGraphEditorBridge::AddGraphOutputParameter(FName OutputName, const FEdGraphPinType& PinType)
{
	if(!IsValid())
	{
		return nullptr;
...
bool UMcpBlueprintGraphEditorBridge::RemoveGraphOutputParameter(FName OutputName)
{
	if(!IsValid())
	{
		return false;
	...
	{
		if(HasUserDefinedPin(TargetNode, OutputName))
		{
...
void UMcpBlueprintGraphEditorBridge::ListLocalVariableNames(TArray<FString>& OutLocalVariableNames) const
{
	if(!IsValid())
	{
		return;
...
TOptional<FEdGraphPinType> UMcpBlueprintGraphEditorBridge::GetLocalVariableType(const FString& LocalVariableName) const
{
	if(!IsValid())
	{
		return {};
...
TOptional<FString> UMcpBlueprintGraphEditorBridge::GetLocalVariableDefaultValue(const FString& LocalVariableName) const
{
	if(!IsValid())
	{
		return {};
...
bool UMcpBlueprintGraphEditorBridge::SetLocalVariableDefaultValue(const FString& LocalVariableName, const FString& NewDefaultValue)
{
	if(!IsValid())
	{
		return false;
...
bool UMcpBlueprintGraphEditorBridge::AddLocalVariable(FName LocalName, const FEdGraphPinType& PinType, const FString& Value)
{
	if(!IsValid())
	{
		return false;
...
bool UMcpBlueprintGraphEditorBridge::RemoveLocalVariable(FName LocalName)
{
	if(!IsValid())
	{
		return false;
...
bool UMcpBlueprintGraphEditorBridge::AddMemberVariable(FName MemberName, const FEdGraphPinType& PinType, const FString& Value)
{
	if(!IsValid())
	{
		return false;
...
UEdGraph* UMcpBlueprintGraphEditorBridge::AddEventDispatcher(FName DispatcherName)
{
	if (!IsValid() || DispatcherName == NAME_None)
	{
		return nullptr;
	}
	...
	{
		if (SignatureGraph && SignatureGraph->GetFName() == DispatcherName)
		{
	...
	if (!FBlueprintEditorUtils::AddMemberVariable(Blueprint, DispatcherName, DispatcherType))
	{
		return nullptr;
	}
...
bool UMcpBlueprintGraphEditorBridge::RemoveMemberVariable(FName MemberName)
{
	if(!IsValid())
	{
		return false;
...
void UMcpBlueprintGraphEditorBridge::SetIsPureFunction(bool bIsPure)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetIsCallInEditorFunction(bool bCallInEditor)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetFunctionIsPublic()
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetFunctionIsProtected()
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetFunctionIsPrivate()
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetIsConstFunction(bool bIsConst)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetIsExecFunction(bool bIsExec)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetIsThreadSafeFunction(bool bIsThreadSafe)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetIsUnsafeDuringActorConstructionFunction(bool bIsUnsafeDuringActorConstruction)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetIsDeprecatedFunction(bool bIsDeprecated)
{
	if(!IsValid())
	{
		return;
...
void UMcpBlueprintGraphEditorBridge::SetDeprecationMessageOnFunction(FText Message)
{
	if(!IsValid())
	{
		return;
...
UK2Node_CallFunction* UMcpBlueprintGraphEditorBridge::AddCallFunctionNode(const FString& FunctionPath)
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_MacroInstance* UMcpBlueprintGraphEditorBridge::AddMacroNode(const FString& MacroPath)
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_IfThenElse* UMcpBlueprintGraphEditorBridge::AddBranchNode()
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_FunctionResult* UMcpBlueprintGraphEditorBridge::AddReturnNode()
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_VariableGet* UMcpBlueprintGraphEditorBridge::AddGetMemberVariableNode(FName MemberName, const FString& ClassPath)
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_VariableSet* UMcpBlueprintGraphEditorBridge::AddSetMemberVariableNode(FName MemberName, const FString& ClassPath)
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_VariableGet* UMcpBlueprintGraphEditorBridge::AddGetLocalVariableNode(FName LocalName)
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_VariableSet* UMcpBlueprintGraphEditorBridge::AddSetLocalVariableNode(FName LocalName)
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_CustomEvent* UMcpBlueprintGraphEditorBridge::AddCustomEventNode(const FString& EventName)
{
	if(!IsValid())
	{
		return nullptr;
...
UK2Node_Event* UMcpBlueprintGraphEditorBridge::AddDispatcherEventNode(FName DispatcherName, UClass* DeclaringClass)
{
	if (!IsValid())
	{
		return nullptr;
...
bool UMcpBlueprintGraphEditorBridge::RetargetNodeClass(UEdGraphNode* Node, UClass* OldClass, UClass* NewClass)
{
...
TArray<FName> UMcpBlueprintGraphEditorBridge::ListComponentEvents(UActorComponent* Component) const
{
	TArray<FName> Result;
	if (!Component)
	{
...
UK2Node_ComponentBoundEvent* UMcpBlueprintGraphEditorBridge::AddComponentBoundEventNode(
...
UEdGraphNode_Comment* UMcpBlueprintGraphEditorBridge::AddCommentNode(const FString& CommentText, FVector2D Location, FVector2D Size)
{
	if (!IsValid())
	{
		return nullptr;
...
UEdGraphNode_Comment* UMcpBlueprintGraphEditorBridge::AddCommentToNodes(const FString& CommentText, const TArray<UK2Node*>& Nodes, int32 Padding)
{
	...
	{
		if (!Node) { continue; }
		const int32 W = Node->NodeWidth > 0 ? Node->NodeWidth : 240;
		const int32 H = Node->NodeHeight > 0 ? Node->NodeHeight : 120;
...
TArray<UEdGraphNode_Comment*> UMcpBlueprintGraphEditorBridge::ListCommentNodes() const
{
...
void UMcpBlueprintGraphEditorBridge::RemoveCommentNode(UEdGraphNode_Comment* CommentNode)
{
...
bool UMcpBlueprintGraphEditorBridge::AddNodePin(UEdGraphNode* Node)
{
	if (!IsValid() || !Node)
	{
		return false;
...
bool UMcpBlueprintGraphEditorBridge::RemoveNodePin(UEdGraphNode* Node, const FMcpBlueprintGraphPin& Pin)
{
	if (!IsValid() || !Node)
	{
		return false;
	...
	UEdGraphPin* NativePin = UMcpBlueprintGraphPinLibrary::GetNativePinSafe(Pin);
...
void UMcpBlueprintGraphEditorBridge::RemoveNodes(const TArray<UK2Node*>& Nodes)
{
	if(!IsValid())
	{
		return;
...
FMcpBlueprintGraphPin UMcpBlueprintGraphEditorBridge::AddGraphInputParameter(FName InputName, const FEdGraphPinType& PinType, const FString& Value)
{
	if(!IsValid())
	{
		return FMcpBlueprintGraphPin{};
...
bool UMcpBlueprintGraphEditorBridge::IsValid() const
{
	return ::IsValid(Graph) && ::IsValid(Blueprint);
}

FVector2D UMcpBlueprintGraphEditorBridge::GetNodeLocation()
{
...
UK2Node_FunctionEntry* UMcpBlueprintGraphEditorBridge::GetFunctionEntryNode() const
{
	if(!IsValid())
	{
		return nullptr;
...
void UMcpBlueprintGraphEditorBridge::HandleNodeSpawned(UK2Node* Result)
{
...
const FProperty* UMcpBlueprintGraphEditorBridge::FindParameterByName(FName Name) const
{
...
const FProperty* UMcpBlueprintGraphEditorBridge::FindLocalByName(FName Name) const
{
	const UFunction* SkeletonFunction = GetSkeletonFunction();
	if(!SkeletonFunction)
	{
...
const UFunction* UMcpBlueprintGraphEditorBridge::GetSkeletonFunction() const
{
...
UFunction* UMcpBlueprintGraphEditorBridge::GetSkeletonFunction()
{
	const UMcpBlueprintGraphEditorBridge* Self = this;
	return const_cast<UFunction*>(Self->GetSkeletonFunction());
}

const UClass* UMcpBlueprintGraphEditorBridge::GetClassFromPath(const FString& ClassPath)
{
...
void UMcpBlueprintGraphEditorBridge::SetFunctionFlagImpl(UFunction* Function, UK2Node_FunctionEntry* EntryNode, EFunctionFlags Flag, bool bIsSet)
{
...
void UMcpBlueprintGraphEditorBridge::ListAvailableNodes(TArray<FString>& Result, const TArray<FMcpBlueprintGraphPin>& ContextPins) const
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UMcpBlueprintGraphEditorBridge::ListAvailableNodes);
	...
	for (const FMcpBlueprintGraphPin& ContextPin : ContextPins)
	{
		if (UEdGraphPin* NativePin = UMcpBlueprintGraphPinLibrary::GetNativePinSafe(ContextPin))
		{
...
UEdGraphNode* UMcpBlueprintGraphEditorBridge::CreateNodeFromName(const FString& NodeWithCategory, FVector2D const Location, const TArray<FMcpBlueprintGraphPin>& ContextPins, UClass* DeclaringClass)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UMcpBlueprintGraphEditorBridge::ListAvailableNodes);
